 ...
 */
namespace {
#define TIMER_HEART_CLOCK_REFRESH 1
#define TIMER_HEART_CLOCK_REFRESH_TIME 1000
...
static S_ACTIVITY_TIMEER REGISTER_ACTIVITY_TIMER_TAB[] = {
	{TIMER_HEART_CLOCK_REFRESH, TIMER_HEART_CLOCK_REFRESH_TIME}
};
...
static void onUI_show() {
	...
	PageManager::getInstance().navigateTo("HeartClockPage");
}
...
static bool onUI_Timer(int id){
	switch (id) {
		case TIMER_HEART_CLOCK_REFRESH:
 ...
 *            触摸事件将继续传递到控件上
 */
static bool onheartClockActivityTouchEvent(const MotionEvent &ev) {
